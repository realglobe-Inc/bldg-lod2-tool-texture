...
class plbldg(plobj):
    ...
    def loadFile(self, filename, options=ploptions()):
        ...
        for app in tree.xpath(
            ...
            for at in app.xpath("app:target", namespaces=nsmap):
                ...
                colist = [
                    ...
                    for v in at.xpath(
                        "app:TexCoordList/app:textureCoordinates", namespaces=nsmap
                    )
                ]
        ...
        for bld in blds:
            ...
            # genericAttributeSet
            genericAttributeSets = bld.xpath(
            ...
            for bb in bld.xpath(
                ...
                if options.bHeightZero:
                    if minheight == 0:
                        ...
                        if b.storeysBelowGround is not None:
                            minheight = minheight + (
                                int(b.storeysBelowGround) * _floorheight
                            )
                        if minheight == 10000:
                            minheight = 0
                    for x in surf:
