  ...
  def read_files(self, folder_path: str):
    ...
    if not os.path.isdir(folder_path):
      ...
      msg = '{}.{}, {}'.format(
          ...
          ModelingMessage.ERR_MSG_IMG_MNG_FOLDER_NOT_FOUND)
    ...
    if len(files) == 0:
      ...
      msg = '{}.{}, {}'.format(
          class_name, func_name,
          ModelingMessage.ERR_MSG_IMG_MNG_IMAGE_NOT_FOUND)
      raise ModelingException(msg)
    ...
    for file in files:
      try:
        ...
        msg = '{}.{}, {}'.format(
            class_name, func_name,
            ModelingMessage.ERR_MSG_IMG_MNG_TFW_READ)
        ...
        msg = '{}.{}, {}'.format(
            class_name, func_name,
            ModelingMessage.ERR_MSG_IMG_MNG_TIFF_READ)
        Log.output_log_write(
            LogLevel.WARN, ModuleType.MODEL_ELEMENT_GENERATION, msg)
        Log.output_log_write(
            LogLevel.WARN, ModuleType.MODEL_ELEMENT_GENERATION, file)
    ...
    if len(self._images) == 0:
      ...
      msg = '{}.{}, {}'.format(
          class_name, func_name,
          ModelingMessage.ERR_MSG_IMG_MNG_READ)
      raise ModelingException(msg)
