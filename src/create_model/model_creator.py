...
from ..util.coordinate_converter import DsmCoordCityGmlCoordConverter
from ..util.coordinate_converter import DsmCoordCityGmlCoordConverterException
...
class ModelCreator:
    ...
    def __init__(self, param: ParamManager):
        ...
        try:
            ...
            # obj出力フォルダの作成
            self._output_folder = Config.OUTPUT_MODEL_OBJ_DIR
    ...
    def create(
        ...
        for gml in gmls:
            try:
                ...
                if not isatty:
                    print(f"Processing {gml.build_id}")
