class ModelingMessage:
    ...
    ERR_MSG_LAS_MNG_NO_GROUND_POINTS = "No ground point cloud data."
    """地面点群データが存在しない"""
    ...
    ERR_MSG_GRAPH_CUT_NO_ROOF_POINTS = "No roof point cloud."
    """地面点と屋根点の分割で屋根点群が取得できなかった"""

    ERR_MSG_GRAPH_CUT_NO_MERGED_ROOF_POINTS = "No merged roof points."
    """高さでマージし、水平連続性で分割後の屋根点群が取得できなかった"""

    # ##### PolygonDivision用メッセージ #####
    ERR_POLYGON_DIVISION_FAIL = "Failed on Polygon Division"
    """屋根ポリゴン分割で失敗"""
    ...
    ERR_MSG_MODEL_DIST_TH = (
        "Enter a value greater than " "or equal to zero for dist_th."
    )
