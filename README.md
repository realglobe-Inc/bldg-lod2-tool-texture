...
2. [3Dモデルファイル-objファイル理解のためのチュートリアル](./docs/tutorials/3d-model/README.md#3Dモデルファイル-objファイル理解のためのチュートリアル)
3. [処理手順（要ドキュメント作成）](#処理手順)
4. [ドキュメントの限界](#ドキュメントの限界)、[コスト限界](#コスト限界)、[技術的限界](#技術的限界)
5. [なぜそこが技術的限界か参考資料で深掘り](#2023年までの開発履歴の参照)
